...
async function addChat(req, res) {
  try {
    ...
    const addedChat = await chatService.add([loggedInUser._id, contact._id.toString()])
    loggedInUser.chats.push(addedChat._id.toString())
    contact.chats.push(addedChat._id.toString())
